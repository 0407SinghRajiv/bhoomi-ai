          ...
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                <div className={`px-2 sm:px-2.5 py-0.5 rounded-md text-[11px] sm:text-xs font-bold uppercase tracking-wider flex items-center gap-1.5 ${
                  isCitizen
                    ? 'bg-blue-50 text-blue-700 border border-blue-200'
                    : 'bg-indigo-50 text-indigo-700 border border-indigo-200'
                }`}>
                  {isCitizen ? <User className="w-3.5 h-3.5" /> : <Shield className="w-3.5 h-3.5" />}
                  <span>{isCitizen ? t('citizen_portal') : t('authority_portal')}</span>
                </div>
              </div>
            </div>

            {/* Middle Nav Items (Desktop / Tablet - lg) */}
            ...
            <div className="hidden md:flex items-center gap-2 sm:gap-3">
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-xs font-semibold bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 shadow-sm transition"
